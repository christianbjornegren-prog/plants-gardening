    ...
    <div className="mb-5 flex items-center gap-2">
      {tillbakaTill && (
        <Link
          to={tillbakaTill}
          aria-label="Tillbaka"
          className="-ml-2 flex size-11 shrink-0 items-center justify-center rounded-lg text-dis hover:text-tusch"
        >
          <TillbakaIkon />
        </Link>
      )}
      <div className="min-w-0 flex-1">
        ...
        <h1 className="line-clamp-2 font-display text-xl/tight font-semibold text-balance text-tusch sm:text-2xl">
          {titel}
        </h1>
  ...
  return (
    <div className="mx-auto w-full max-w-2xl p-5 md:p-8">
      ...
      <p className="mt-4 text-center">
        <Link to={tillbakaTill} className="text-orm underline underline-offset-4">
          Tillbaka
        </Link>
      </p>
    </div>
...
export function TomtLage({
  ...
  return (
    <div className="flex flex-col items-center gap-3 px-6 py-16 text-center">
      <h2 className="font-display text-lg font-semibold text-tusch">{rubrik}</h2>
