...
/**
 * Googles G-märke i enfärgat utförande (Googles sanktionerade variant för
 * färgade och mörka underlag). Fyllnad i stället för kontur, därför utanför
 * ikonProps.
 */
export function GoogleIkon(props: SVGProps<SVGSVGElement>) {
  return (
