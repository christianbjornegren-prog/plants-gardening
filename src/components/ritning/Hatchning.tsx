  ...
  return (
    <defs>
      ...
      <pattern id="h-bygg" patternUnits="userSpaceOnUse" width="0.3" height="0.3">
        <rect width="0.3" height="0.3" fill={ton('upphojd', 90)} />
        <path
      ...
      <pattern id="h-trall" patternUnits="userSpaceOnUse" width="0.14" height="0.6">
        <rect width="0.14" height="0.6" fill={ton('tra', 38)} />
        <path d="M0 0 V0.6" stroke={ton('tusch', 24)} strokeWidth="0.018" />
        <path
      ...
      <pattern id="h-rabatt" patternUnits="userSpaceOnUse" width="0.42" height="0.42">
        <rect width="0.42" height="0.42" fill={ton('orm', 26)} />
        <g stroke={ton('orm', 70)} strokeWidth="0.016" strokeLinecap="round" fill="none">
        ...
        <circle cx="0.32" cy="0.1" r="0.015" fill={ton('tusch', 24)} />
        <circle cx="0.09" cy="0.33" r="0.012" fill={ton('tusch', 18)} />
      </pattern>

      {/* Pallkrage: liggande brädor med synlig ram. */}
      <pattern id="h-pallkrage" patternUnits="userSpaceOnUse" width="0.4" height="0.13">
        <rect width="0.4" height="0.13" fill={ton('tra', 45)} />
        <path d="M0 0 H0.4" stroke={ton('tusch', 28)} strokeWidth="0.02" />
        <path d="M0.2 0 V0.13" stroke={ton('tusch', 16)} strokeWidth="0.014" />
      </pattern>
      ...
      <pattern id="h-gras" patternUnits="userSpaceOnUse" width="0.34" height="0.34">
        <rect width="0.34" height="0.34" fill={ton('lov', 32)} />
        <g stroke={ton('orm', 62)} strokeWidth="0.015" strokeLinecap="round" fill="none">
      ...
      <pattern id="h-hack" patternUnits="userSpaceOnUse" width="0.36" height="0.36">
        <rect width="0.36" height="0.36" fill={ton('orm', 34)} />
        <path
      ...
      <pattern id="h-trad" patternUnits="userSpaceOnUse" width="0.66" height="0.66">
        <rect width="0.66" height="0.66" fill={ton('lov', 36)} />
        <g fill="none" stroke={ton('orm', 55)} strokeWidth="0.022" strokeLinecap="round">
      ...
      <pattern id="h-stenparti" patternUnits="userSpaceOnUse" width="0.62" height="0.62">
        <rect width="0.62" height="0.62" fill={ton('upphojd', 95)} />
        <g fill={ton('dis-svag', 32)} stroke={ton('tusch', 28)} strokeWidth="0.012">
      ...
      <pattern id="h-grus" patternUnits="userSpaceOnUse" width="0.16" height="0.16">
        <rect width="0.16" height="0.16" fill={ton('upphojd', 95)} />
        <g fill={ton('tusch', 26)}>
      ...
      <pattern id="h-vatten" patternUnits="userSpaceOnUse" width="0.5" height="0.28">
        <rect width="0.5" height="0.28" fill="color-mix(in srgb, var(--color-lov) 26%, var(--color-panel))" />
        <g fill="none" stroke={ton('orm', 55)} strokeWidth="0.018" strokeLinecap="round">
      ...
      <pattern id="h-annat" patternUnits="userSpaceOnUse" width="0.34" height="0.34">
        <rect width="0.34" height="0.34" fill={ton('upphojd', 80)} />
        <path d="M0 0.34 L0.34 0" stroke={ton('tusch', 14)} strokeWidth="0.018" />
      </pattern>
    </defs>
  )
}
